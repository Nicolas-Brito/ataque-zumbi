...
function preload() {
  ...
  //carregar imagens lose, winning, explosionSound
...
function setup() {
  ...
  heart1 = createSprite(displayWidth-580,40,20,20)
  heart1.addImage("heart1",heart1Img)
  heart1.scale=0.4
  heart2 = createSprite(displayWidth-540,40,20,20)
...
function enemy() {
  if (frameCount % 50 === 0) {
    ...
    zombie= createSprite(random(1100,1500),random(270,800),40,40)
